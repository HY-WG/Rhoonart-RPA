...
_MOCK_CHANNEL_VIDEOS = [
    {
        "video_id": "video-21c-princess",
        "title": "21세기 대군부인",
        "description": "권리사 승인 가능한 대표 샘플 영상입니다.",
        "channel_name": "호영 채널",
    ...
    {
        "video_id": "video-betting-fact",
        "title": "베팅 온 팩트",
        "description": "채널 보유 영상 중 쿠폰/소명 신청 테스트에 사용하는 샘플입니다.",
        "channel_name": "호영 채널",
        "contact_email": "hoyoungy2@gmail.com",
    ...
    {
        "video_id": "video-store-kangho",
        "title": "강호동네서점",
        "description": "저작권 소명 요청으로 연결되는 샘플 영상입니다.",
        "channel_name": "호영 채널",
        "contact_email": "hoyoungy2@gmail.com",
        "rights_holder_name": "권리사 A",
        "platform": "카카오숏폼",
        "availability_status": "이용 가능",
        "thumbnail_emoji": "📚",
    },
